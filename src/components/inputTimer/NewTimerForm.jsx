  ...
  const typeHandler = (event) => {
    ...
    setBtnStatus(() => {
      if (btnType === "Cooking" && btnClicked === false) {
        setToastMessage("🥣 Cooking Timer Added!");
        return {
          cooking: false,
          errend: true,
          event: true,
      ...
      if (btnType === "Errend" && btnClicked === false) {
        setToastMessage("🏃 Errend Timer Added!");
        return {
          cooking: true,
          errend: false,
          event: true,
      ...
      if (btnType === "Event" && btnClicked === false) {
        setToastMessage("🎫 Event Timer Added!");
        return {
          cooking: true,
          errend: true,
          event: false,
    ...
    <form className={classes.form} onSubmit={submitHandler}>
      <div className="field">
        ...
        <input
          ...
          maxlength="40"
          ref={nameRef}
          placeholder="Input Alarm Name"></input>
      </div>
      <div className="field">
